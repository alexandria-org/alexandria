...
aws lambda update-function-configuration --function-name cc-indexer --handler cc_indexer --runtime provided --role arn:aws:iam::259015057813:role/service-role/cc-parser-role-kqqwot3e
